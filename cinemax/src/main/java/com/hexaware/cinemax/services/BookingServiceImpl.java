...
public class BookingServiceImpl implements IBookingService {
    ...
    @Override
    public Booking bookSeat(BookingDTO bookingDTO) {
      ...
      //email
      		sendMail(user.getUsername(), booking.getSeatNumbers(),show.getShowName(),show.getShowDateTime(),show.getMovie().getTitle(), show.getTheatre().getName(),show.getTheatre().getLocation(),user.getEmail());
    ...
    public void sendMail(String username, String seatNumbers,String showName,LocalDateTime showDateTime, String movieName, String theatreName,String theatreLocation,String email) {
		SimpleMailMessage message = new SimpleMailMessage();
	message.setFrom(fromMail);
	message.setSubject("Welcome to Cinemax : "+ username );
	message.setText( "Username is " + username + "\n" + "Movie name is " + movieName + "\n" + "Theatre name is " + theatreName + "\n" + "Theatre Location is " + theatreLocation + "\n" + "Show name is " + showName + "\n" + "Show Date and Time is " + showDateTime + "\n" + "Seat numbers are " + seatNumbers);
